    ...
    >
      ...
      <CardContent className="space-y-4">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              required
              className="focus:ring-[var(--accent-ij-wash)] focus:border-[var(--accent-ij)]"
              style={{
                borderColor: 'var(--paper-ink)',
                background: 'var(--card)',
                color: 'var(--ink)',
          ...
          <Button
            type="submit"
            className="w-full rounded-full font-semibold text-white border-0 hover:opacity-90"
            style={{
        ...
        <button
          ...
          style={{
            border: '1px solid var(--accent-ij)',
        ...
        <p className="text-center text-sm" style={{ color: 'var(--ink-4)' }}>
          No account?{' '}
          <Link href="/signup" style={{ color: 'var(--accent-ij-ink)', fontWeight: 500 }}>
            Sign up free
          </Link>
        </p>
      </CardContent>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="h-96 animate-pulse rounded-xl" style={{ background: 'var(--paper-2)' }} />}>
      <LoginForm />
    </Suspense>
  )
}
